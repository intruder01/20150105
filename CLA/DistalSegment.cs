...
namespace OpenHTM.CLA
{
	...
	public class DistalSegment : Segment
	{
		...
		{
			return " DistSeg (Cell[[" + parentCell.Column.PositionInRegion.X + "," + parentCell.Column.PositionInRegion.Y + "]," + parentCell.Index + "])"
					+ " Nsteps=" + this.NumberPredictionSteps + " Nsyns=" + this.Synapses.Count
